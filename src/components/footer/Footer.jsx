...
const Footer = () => {
  return (
    <div className="px-[32px] py-[16px] font-inter flex flex-col gap-5 ">
      <div className="flex flex-col gap-4">
        ...
        <p className="text-[14px] leading-5 font-normal text-dark-textDarkLight ">
          The React component library of startups
        </p>
      </div>
      ...
      <div className="flex flex-row justify-between">
        ...
        <div className="flex gap-4 text-dark-textDarkLight items-center ">
          <a
            href="https://www.facebook.com/shaikotahmed.22.asif/"
            target={"_blank"}
            className="text-[14px] leading-5 font-normal hover:text-white"
          >
            Contact
          </a>
          <a
            href="https://github.com/shaikot-asif"
            target={"_blank"}
